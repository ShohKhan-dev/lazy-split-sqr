...
class TestUserAPI(unittest.TestCase):
    ...
    def test_get_user_expenses_success(self):
        ...
        assert (
            data[0]["expense_participant_id"]
            == expense_participant.expense_participant_id
        )
...
class TestExpenseAPI(unittest.TestCase):
    ...
    def test_create_expense_success(self):
        ...
        expense_create_data = ExpenseCreate(
    ...
    def test_create_expense_participant_success(self):
        ...
        expense_create_data = CreateExpenseParticipant(
            expense_id=1, user_id=1, amount_paid=100
        )
